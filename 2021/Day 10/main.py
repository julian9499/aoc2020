...
def part_1(advent_of_code):
    ...
    with open('input.txt', 'r') as input_file:
        ...
        for i in adapters:
            print(i-current)
            countDiff[i-current-1] = countDiff[i-current-1] + 1
            current = i

        print(current)

        advent_of_code.answer(1, countDiff[0]* countDiff[2])
...
def part_2(advent_of_code):
    ...
    with open('input.txt', 'r') as input_file:
        for line in input_file:
            adapters.append(int(line.strip()))
        prob_input = [0] + adapters
        step_memo = {0: 1}

        adapters.sort()

        f = [0] + adapters + [max(adapters)+3]
        l = len(f)
        ways = [1] + [0] * (l - 1)
        for i in range(1, l):
        ...
        advent_of_code.answer(2, ways[-1])
